...
const Footer = () => {
    return (
        <footer className='bg-[#2f3136] flex justify-evenly pt-10'>
            <div className='w-[25%]'>
                <h1 className='footerHeader font-bold text-[20px] sm:text-[30px]'>IMAGINE A PLACE</h1>
                ...
                <div className='footer flex gap-3 mt-2'>
            ...
            <div className='grid grid-cols-2 sm:flex sm:flex-row gap-10 justify-between'>
                <div >
                    <h1 className='footerHeader'>Product</h1>
                    <p className='footer'>Download</p>
                    <p className='footer'>Nitro</p>
                    <p className='footer'>Status</p>
                </div>
                <div >
                    <h1 className='footerHeader'>Company</h1>
                    <p className='footer'>About</p>
                    <p className='footer'>Jobs</p>
                    <p className='footer'>Brand</p>
                    <p className='footer'>Newsroom</p>
                </div>
                <div>
                    <h1 className='footerHeader'>Resources</h1>
                    <p className='footer'>College</p>
                    <p className='footer'>Support</p>
                    <p className='footer'>Safety</p>
                    <p className='footer'>Blog</p>
                    <p className='footer'>Feedback</p>
                    <p className='footer'>Build</p>
                    <p className='footer'>StreamKit</p>
                    <p className='footer'>Creators</p>
                    <p className='footer'>Community</p>
                    <p className='footer'>Official 3rd Party <br /> March</p>
                </div>
                <div>
                    <h1 className='footerHeader'>Policies</h1>
                    <p className='footer'>Terms</p>
                    <p className='footer'>Privacy</p>
                    <p className='footer'>Cookie Settings</p>
                    <p className='footer'>Guidelines</p>
                    <p className='footer'>Acknowledgements</p>
                    <p className='footer'>Licenses</p>
                    <p className='footer'>Moderation</p>
                    <p className='footer'>Comapny <br /> Information</p>
                </div>
            </div>
        </footer>
    )
